...
C_DEPS += \
./boot2_partition/boot_flags.d \
./boot2_partition/crc32.d \
./boot2_partition/partition.d 

OBJS += \
./boot2_partition/boot_flags.o \
./boot2_partition/crc32.o \
./boot2_partition/partition.o 


# Each subdirectory must supply rules for building sources it contributes
boot2_partition/%.o: ../boot2_partition/%.c boot2_partition/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-boot2_partition

clean-boot2_partition:
	-$(RM) ./boot2_partition/boot_flags.d ./boot2_partition/boot_flags.o ./boot2_partition/crc32.d ./boot2_partition/crc32.o ./boot2_partition/partition.d ./boot2_partition/partition.o

.PHONY: clean-boot2_partition
