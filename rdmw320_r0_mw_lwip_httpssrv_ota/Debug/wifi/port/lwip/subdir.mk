...
C_SRCS += \
../wifi/port/lwip/net.c \
../wifi/port/lwip/wifi_netif.c 

C_DEPS += \
./wifi/port/lwip/net.d \
./wifi/port/lwip/wifi_netif.d 

OBJS += \
./wifi/port/lwip/net.o \
./wifi/port/lwip/wifi_netif.o 


# Each subdirectory must supply rules for building sources it contributes
wifi/port/lwip/%.o: ../wifi/port/lwip/%.c wifi/port/lwip/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-wifi-2f-port-2f-lwip

clean-wifi-2f-port-2f-lwip:
	-$(RM) ./wifi/port/lwip/net.d ./wifi/port/lwip/net.o ./wifi/port/lwip/wifi_netif.d ./wifi/port/lwip/wifi_netif.o

.PHONY: clean-wifi-2f-port-2f-lwip
