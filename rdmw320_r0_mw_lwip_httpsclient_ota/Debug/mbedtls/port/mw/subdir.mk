...
C_DEPS += \
./mbedtls/port/mw/aes_alt.d \
./mbedtls/port/mw/ccm_alt.d \
./mbedtls/port/mw/ksdk_mbedtls.d 

OBJS += \
./mbedtls/port/mw/aes_alt.o \
./mbedtls/port/mw/ccm_alt.o \
./mbedtls/port/mw/ksdk_mbedtls.o 


# Each subdirectory must supply rules for building sources it contributes
mbedtls/port/mw/%.o: ../mbedtls/port/mw/%.c mbedtls/port/mw/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-mbedtls-2f-port-2f-mw

clean-mbedtls-2f-port-2f-mw:
	-$(RM) ./mbedtls/port/mw/aes_alt.d ./mbedtls/port/mw/aes_alt.o ./mbedtls/port/mw/ccm_alt.d ./mbedtls/port/mw/ccm_alt.o ./mbedtls/port/mw/ksdk_mbedtls.d ./mbedtls/port/mw/ksdk_mbedtls.o

.PHONY: clean-mbedtls-2f-port-2f-mw
