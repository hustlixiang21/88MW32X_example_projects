...
wifi/port/os/%.o: ../wifi/port/os/%.c wifi/port/os/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-wifi-2f-port-2f-os

clean-wifi-2f-port-2f-os:
	-$(RM) ./wifi/port/os/os.d ./wifi/port/os/os.o

.PHONY: clean-wifi-2f-port-2f-os
