...
static mlan_status wlan_11d_process_country_info(mlan_private *pmpriv, BSSDescriptor_t *pbss_desc)
{
    ...
    if (wlan_11d_parse_domain_info(pmadapter, &pbss_desc->country_info, (mlan_band_def)pbss_desc->bss_band,
...
mlan_status wlan_11d_parse_dnld_countryinfo(mlan_private *pmpriv, BSSDescriptor_t *pbss_desc)
{
    ...
    if (wlan_11d_is_enabled(pmpriv))
    {
        ...
        if (pbss_desc != MNULL)
        {
            ...
            ret = wlan_11d_parse_domain_info(pmadapter, &pbss_desc->country_info, (mlan_band_def)pbss_desc->bss_band,
                                             &bssdesc_region_chan);
