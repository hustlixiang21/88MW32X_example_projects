...
C_DEPS += \
./flash/mflash/mflash_file.d 

OBJS += \
./flash/mflash/mflash_file.o 


# Each subdirectory must supply rules for building sources it contributes
flash/mflash/%.o: ../flash/mflash/%.c flash/mflash/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-flash-2f-mflash

clean-flash-2f-mflash:
	-$(RM) ./flash/mflash/mflash_file.d ./flash/mflash/mflash_file.o

.PHONY: clean-flash-2f-mflash
