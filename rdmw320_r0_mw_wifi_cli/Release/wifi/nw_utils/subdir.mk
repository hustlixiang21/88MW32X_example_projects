...
C_SRCS += \
../wifi/nw_utils/iperf.c \
../wifi/nw_utils/wifi_ping.c 

C_DEPS += \
./wifi/nw_utils/iperf.d \
./wifi/nw_utils/wifi_ping.d 

OBJS += \
./wifi/nw_utils/iperf.o \
./wifi/nw_utils/wifi_ping.o 


# Each subdirectory must supply rules for building sources it contributes
wifi/nw_utils/%.o: ../wifi/nw_utils/%.c wifi/nw_utils/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-wifi-2f-nw_utils

clean-wifi-2f-nw_utils:
	-$(RM) ./wifi/nw_utils/iperf.d ./wifi/nw_utils/iperf.o ./wifi/nw_utils/wifi_ping.d ./wifi/nw_utils/wifi_ping.o

.PHONY: clean-wifi-2f-nw_utils
